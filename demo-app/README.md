...
## Re-bake OCR (optional)

The baked PDF is generated by the OCR script in this repo:
...
Notes:
- This uses OCRmyPDF + Tesseract + Ghostscript under the hood.
- If OCRmyPDF is missing, the script will tell you how to install it.
